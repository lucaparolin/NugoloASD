using NugoloASD.Web.DTOs.Corsi;
using FluentValidation;

namespace NugoloASD.Web.Validators.Corsi;

/// <summary>
/// Validator per CorsoCreateDto
/// </summary>
public class CorsoCreateDtoValidator : AbstractValidator<CorsoCreateDto>
{
    public CorsoCreateDtoValidator()
    {
        RuleFor(x => x.Nome)
